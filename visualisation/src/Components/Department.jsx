...
function Card({ heading, text, publication, faculty, Icon, link }) {
  return (
    <a className="flex flex-col items-center text-center p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 font-serif"
    href={link}>
      <Icon className="text-5xl mb-4 text-blue-600" />
      ...
      <br></br>
      <p className="justify-center items-center flex ">Explore Domain</p>
    </a>
  );
}
...
function Department() {
  return (
    <div className="bg-gray-50 p-10 rounded-lg shadow-md min-h-[600px]">
      ...
      <h2 className="text-md justify-center items-center flex mb-10 font-oswald text-gray-600">
